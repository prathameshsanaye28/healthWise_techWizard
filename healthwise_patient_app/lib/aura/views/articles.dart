...
class _NewsScreenState extends State<NewsScreen> {
  ...
  Future<void> fetchNews() async {
    ...
    const String apiUrl = kIsWeb
        ? 'https://cors-anywhere.herokuapp.com/https://gnews.io/api/v4/search?q=health+fitness+mental+health&lang=en&apikey=$apiKey'
        : 'https://gnews.io/api/v4/search?q=health+fitness+mental+health&lang=en&country=in&apikey=$apiKey';
